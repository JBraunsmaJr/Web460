<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pgCheckOut.aspx.cs" Inherits="BraunsmaWeek4.pgCheckOut" 
...
<asp:Content ID="ContentArea1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <label>Customers in Database:</label>
    <br />
    <asp:GridView ID="gvOrderList" runat="server" Font-Size="9"></asp:GridView><br />

    <label>Customers in XML File:</label><br />
    <asp:GridView ID="gvXml" runat="server" Font-Size="9"></asp:GridView><br />
...
<asp:Content ID="ContentArea2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <br />
    <asp:Button ID="btnUpdateXml" runat="server" Text="Update XML File" CssClass="btn btn-info" OnClick="btnUpdateXml_Click" />
</asp:Content>